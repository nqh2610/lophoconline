...
export default function VideoCallPage() {
  ...
  useEffect(() => {
    const joinVideoCall = async () => {
      try {
        console.log('🔍 [VideoCallPage] Joining with accessToken:', accessToken);
        ...
        console.log('📥 [VideoCallPage] API Response:', {
        ...
        console.error('❌ [VideoCallPage] Error:', err);
  ...
  const handleMeetingEnd = () => {
    console.log('👋 [VideoCallPage] Meeting ended, redirecting...');
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black">
        <div className="text-center space-y-4 p-8">
          ...
          <p className="text-white text-xl font-semibold">Đang xác thực và kết nối...</p>
