        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-muted-foreground text-lg mb-6">
              LopHoc.Online là nền tảng kết nối gia sư và học viên trực tuyến hàng đầu tại Việt Nam.
            </p>
            ...
            <p className="text-muted-foreground mb-6">
              ...
              kết nối họ với những gia sư giỏi nhất trên toàn quốc thông qua công nghệ hiện đại.
            </p>
            ...
            <ul className="space-y-3 text-muted-foreground">
              <li>✓ <strong>Chất lượng:</strong> Cam kết mang đến gia sư được xác thực và chất lượng giảng dạy tốt nhất</li>
